  ...
  return (
    ...
    >
      ...
      <div className="mt-6 grid gap-4 md:grid-cols-[minmax(0,1.6fr)_minmax(0,1fr)] items-stretch">
        <article className="card p-4 flex flex-col justify-between space-y-3">
          <div className="space-y-2">
            <p className="text-[11px] font-medium uppercase tracking-[0.2em] text-primary-300">
        ...
        <div className="card p-4 space-y-3 text-xs sm:text-sm text-slate-300">
