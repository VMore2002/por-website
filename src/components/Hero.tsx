    ...
    <div className="section-container flex flex-col-reverse gap-10 lg:flex-row lg:items-center">
      <div className="space-y-6 relative">
        ...
        <p className="max-w-2xl text-sm sm:text-base text-slate-300 leading-relaxed">
          ...
          Docker. Experienced in secure VPC architectures, load balancing,
          auto scaling, monitoring, and DevOps best practices backed by a
          strong foundation in Linux and cloud networking.
        </p>
